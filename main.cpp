...
/*
  ...
  // TEST: Copy constructor (with different allocator types)
  LinkedList<int, logging_allocator<int, 10>> list_cp2 = list_default;
  for (auto it = list_cp2.cbegin(), itF(list_cp2.cend()); it != itF; ++it) {
    std::cout << *it << " ";
  }
  std::cout << std::endl;
